...
Ready to contribute? Here's how to set up `see_scripts` for local development.

1. Fork the `see_scripts` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/see_scripts.git
...
tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd see_scripts
    (dvlpt) see_scripts$ flake8
    (dvlpt) see_scripts$ nosetests
    (dvlpt) see_scripts$ tox
...
3. The pull request should work for Python 2.7, 3.4, and 3.5. Check
   https://travis-ci.org/revesansparole/see_scripts/pull_requests
...
.. _issues: https://github.com/revesansparole/see_scripts/issues
